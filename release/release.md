...
Det var väldigt intressant och lärorik att analysera sin kod efter att ha läst boken. Det är många saker som jag har tagit med mig och kommer att tänka på när jag skriver kod i fortsättningen. **Use Intention-Revealing Names**, **Small!**, **Do One Thing**, **Function Arguments** och **One Level of Abstraction per Function** är de regler som jag upplever har gjort att min kod redan börjar bli mycket bättre. 
...
<br><br>
Överlag tycker jag att det har varit väldigt kul att se på koden på det här sättet. Jag har försökt att alltid skriva bra och ren kod men inte riktigt vetat hur jag ska tänka. Jag tycker att boken har gett mig en del ögonöppnare och verktyg för att kunna bli bättre på det.
<br><br>
Jag hade inte så mycket förslag på förändringar i analysen av funktioner som kanske syns. Jag hade inte speciellt långa metoder eftersom jag läste boken först och bland annat hade ovan nämnda regel i huvudet om att göra metoderna så små som möjligt. Jag hade redan innan jag skrev reflektionen gjort så mycket jag har kunnat för att försöka följa de reglerna.Jag skulle säkert kunna sitta länge och försöka att få metoderna på samma abstraktionsnivå, men som sagt, med en tidsbegränsning på laborationen måste jag också inse när det är dags att ge sig.
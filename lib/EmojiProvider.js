...
export class EmojiProvider {
   ...
   */
  getEmojisOnly () {
    return this.getEmojiObjects().map(element => { 
  ...
  replaceEmoticonsWithEmojis (text) {
    const emoticonConverter = new EmoticonConverter(this.getEmojiObjects())
   ...
   */
  #searchForEmoji (tag) {
    const emojiObject = this.getEmojiObjects().find(element => element.tag === tag)

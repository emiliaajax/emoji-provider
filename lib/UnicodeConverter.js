...
export class UnicodeConverter {
  ...
  convertUnicodesToEmojis (emojiObjectArray) {
    this.#validateIfObject(emojiObjectArray)
    this.#validateIfHasCorrectProperties(emojiObjectArray)

...
// const emoji = emojiProvider.getEmojiByTag('coffee')
...
// for (const emoji of emojiProvider.getEmojisThatMatchesText('sad')) {
//   emojisFromInputText += ' ' + emoji
// }

// let emojisFromGivenCategories = ''
// for (const emoji of emojiProvider.getEmojisOnlyFromCategory('symbols')) {

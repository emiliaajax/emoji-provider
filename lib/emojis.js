 ...
 */
export class Emojis {
  static #categories = ['smileysAndPeople', 'animalsAndNature', 'foodAndDrink', 'activity', 'travelAndPlaces', 'objects']
  /**
   ...
   */
  static getEmojisByCategory (...categories) {
   ...
   */
  static #checkIfValidCategory (category) {
